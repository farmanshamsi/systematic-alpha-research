"""Build the frozen Day 24 CQF technical-report bundle."""
...
DEFAULT_ARTIFACT_DIRECTORY: Final[Path] = Path("artifacts/day24")
DEFAULT_OUTPUT_REPORT: Final[Path] = Path(
    "outputs/AXIOM_DAY24_TECHNICAL_REPORT_DRAFT.html"
)
...
def main(argv: Sequence[str] | None = None) -> tuple[Path, ...]:
    ...
    print("===== DAY 24 TECHNICAL REPORT COMPLETE =====")
